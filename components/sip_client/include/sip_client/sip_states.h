...
struct sip_states
{
    auto operator()() const noexcept // NOLINT(bugprone-exception-escape)
    {
        ...
        const auto action_reply_timeout = [](SipClientT& sip, const auto& event) {
            (void)event;
            sip.handle_reply_timeout();
        };

        return make_transition_table(
            *idle + event<ev_start> = "waiting_for_auth_reply"_s,
            "waiting_for_auth_reply"_s + sml::on_entry<_> / action_register_unauth,
            "waiting_for_auth_reply"_s + event<ev_401_unauthorized> / action_register_auth,
            "waiting_for_auth_reply"_s + event<ev_reply_timeout> / action_register_retry,
            ...
            "registered"_s + event<ev_reregister> = "waiting_for_auth_reply"_s,
            ...
            "registered"_s + event<ev_start> = "waiting_for_auth_reply"_s,
            ...
            "calling"_s + event<ev_reply_timeout> / action_reply_timeout = "registered"_s,
            "calling"_s + event<ev_start> = "waiting_for_auth_reply"_s,
            ...
            "call_established"_s + event<ev_start> = "waiting_for_auth_reply"_s,
            ...
            "ending_call"_s + event<ev_start> = "waiting_for_auth_reply"_s,
